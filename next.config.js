...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/pages/production-goal-planner.html', destination: '/production-goal-planner', permanent: true },
      ...
      { source: '/pages/yield-forecasting.html', destination: '/yield-forecasting', permanent: true },
