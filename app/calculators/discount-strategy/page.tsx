...
export default function DiscountStrategySimulator() {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://budcalculator.com/calculators/discount-strategy" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "operatingSystem": "Web",
            "description": "Test the impact of discounts on average order value and margin. Useful for dispensary managers setting promos.",
            "creator": {
              "@type": "Organization",
              "name": "BUD Calculator"
            },
