...
export default function InfusionDosageCalculator() {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://budcalculator.com/calculators/infusion-dosage" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "SoftwareApplication",
            "name": "Infusion Dosage Calculator",
            "url": "https://budcalculator.com/calculators/infusion-dosage",
            "applicationCategory": "BusinessApplication",
            "operatingSystem": "Web",
            "description": "Determine how much THC or CBD to infuse based on desired potency, distillate strength, and batch size.",
            "creator": {
              "@type": "Organization",
              "name": "BUD Calculator"
            },
